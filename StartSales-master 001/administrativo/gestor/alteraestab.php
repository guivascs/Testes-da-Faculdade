...
$selectestab = ("select estabelecimento.razaosocial, estabelecimento.nomefantasia, estabelecimento.cnpj, estabelecimento.ie, estabelecimento.tiporegime, contatoestab.telefone1, contatoestab.telefone2, 
contatoestab.celular, contatoestab.email, enderecoestab.cep, enderecoestab.logradouro, enderecoestab.bairro, enderecoestab.municipio, enderecoestab.cidade, enderecoestab.uf, enderecoestab.numero, enderecoestab.complemento from estabelecimento
inner join contatoestab on estabelecimento.idestab = contatoestab.idestab inner join enderecoestab on estabelecimento.idestab = enderecoestab.idestab WHERE estabelecimento.idestab = $idestab") or die(mysqli_error());
$dadosestab = $conexao->query($selectestab);
...
<head>
    ...
    <!-- Titulo da Pagina -->
    <title>Altere o Estabelecimento</title>
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <!-- MAIN CONTENT -->
               <form action="php/updateestab.php?idestab=<?php echo $idestab; ?>" method="POST">
                                ...
                                <div style="float:left;width:900px;height:100px;">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong>Alteração de Estabelecimento</strong>
                                            <button type="submit" id="salvar" class="btn btn-success">Salvar</button>
                                            <button type="button" id="excluir" class="btn btn-warning"><a href="php/deleteestab.php?idestab=<?php echo $idestab; ?>">Excluir</a></button>
                                            <button type="button" id="cancelar" class="btn btn-danger"><a href="listaestab.php">Cancelar</a></button>        
                                        </div>
                                        <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="selectSm" class=" form-control-label">Tipo de Regime</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <select name="tiporegime" id="tiporegime" class="form-control-sm form-control">
                                                        <option value="<?php echo $tiporegime  ?>"><?php echo $tiporegime  ?></option>
