                ...
                <div class="row">
                    ...
                    <!-- DATA TABLE -->
                        ...
                        <div class="table-data__tool">
                            ...
                            <div class="table-data__tool-right">
                                ...
                                <i class="zmdi zmdi-plus"></i><a href="cadastrocliente.php">Adicionar</a></button>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive table-responsive-data2">
                        <table class="table table-data2">
                            ...
                            <div>
                            <?php
                                $selectcliente = ("SELECT idcliente, nome, sobrenome, cpf, rg, ativo FROM cliente") or die(mysqli_error());
                            ...
                            ?>
                                <tr class="tr-shadow">
                                    <td><?php echo $nome  ?></td>
                                    <td>
                                    <span class="block-email"><?php echo $sobrenome  ?></span>
                                    </td>
                                    <td class="desc"><?php echo $cpf  ?></td>
                                    <td><?php echo $rg  ?></td>
                                    <td><?php echo $ativo  ?></td>
                                    <td>
                                    <div class="table-data-feature">
                                            <a class="item" href="alteracliente.php?idcliente=<?php echo $idcliente; ?>" data-toggle="tooltip" data-placement="top" title="Edit">
