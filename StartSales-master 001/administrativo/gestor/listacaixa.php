        ...
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                    <!-- DATA TABLE -->
                        <h3 class="title-5 m-b-35">Lista de Caixas</h3>
                        <div class="table-data__tool">
                            ...
                            <div class="table-data__tool-right">
                                ...
                                <i class="zmdi zmdi-plus"></i><a href="cadastrocaixa.php">Adicionar</a></button>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive table-responsive-data2">
                        <table class="table table-data2">
                            ...
                            <div>
                            <?php
                                $selectcaixa = ("SELECT idcaixa, numero, ativo FROM caixa") or die(mysqli_error());
                            ...
                            ?>
                                <tr class="tr-shadow">
                                    ...
                                    <td>
                                    <span class="block-email"><?php echo $ativo  ?></span>
                                    </td>
                                    <td>
                                    <div class="table-data-feature">
                                            <a class="item" href="alteracaixa.php?idcaixa=<?php echo $idcaixa; ?>" data-toggle="tooltip" data-placement="top" title="Edit">
